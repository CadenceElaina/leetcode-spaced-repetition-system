...
const reviewQueue = [
  { stateId: "d8", problemId: 12, title: "Trapping Rain Water", leetcodeNumber: 42, neetcodeUrl: "https://neetcode.io/problems/trapping-rain-water", difficulty: "Hard" as const, category: "Two Pointers", totalAttempts: 3, daysOverdue: 5, retrievability: 0.22, stability: 7.2, lastReviewedAt: daysAgo(12) },
  { stateId: "d5", problemId: 25, title: "Min Stack", leetcodeNumber: 155, neetcodeUrl: "https://neetcode.io/problems/minimum-stack", difficulty: "Medium" as const, category: "Stack", totalAttempts: 1, daysOverdue: 4, retrievability: 0.31, stability: 1.4, lastReviewedAt: daysAgo(11) },
  { stateId: "d3", problemId: 10, title: "Container With Most Water", leetcodeNumber: 11, neetcodeUrl: "https://neetcode.io/problems/max-water-container", difficulty: "Medium" as const, category: "Two Pointers", totalAttempts: 2, daysOverdue: 3, retrievability: 0.38, stability: 3.5, lastReviewedAt: daysAgo(10) },
  { stateId: "d6", problemId: 24, title: "Evaluate Reverse Polish Notation", leetcodeNumber: 150, neetcodeUrl: "https://neetcode.io/problems/evaluate-reverse-polish-notation", difficulty: "Medium" as const, category: "Stack", totalAttempts: 1, daysOverdue: 2, retrievability: 0.48, stability: 1.1, lastReviewedAt: daysAgo(7) },
  { stateId: "d1", problemId: 1, title: "Two Sum", leetcodeNumber: 1, neetcodeUrl: "https://neetcode.io/problems/two-integer-sum", difficulty: "Easy" as const, category: "Arrays & Hashing", totalAttempts: 3, daysOverdue: 2, retrievability: 0.45, stability: 4.8, lastReviewedAt: daysAgo(8) },
  { stateId: "d7", problemId: 32, title: "Binary Search", leetcodeNumber: 704, neetcodeUrl: "https://neetcode.io/problems/binary-search", difficulty: "Easy" as const, category: "Binary Search", totalAttempts: 2, daysOverdue: 1, retrievability: 0.55, stability: 2.8, lastReviewedAt: daysAgo(5) },
  { stateId: "d2", problemId: 3, title: "Group Anagrams", leetcodeNumber: 49, neetcodeUrl: "https://neetcode.io/problems/anagram-groups", difficulty: "Medium" as const, category: "Arrays & Hashing", totalAttempts: 2, daysOverdue: 1, retrievability: 0.52, stability: 3.1, lastReviewedAt: daysAgo(6) },
  { stateId: "d4", problemId: 13, title: "Valid Palindrome", leetcodeNumber: 125, neetcodeUrl: "https://neetcode.io/problems/is-palindrome", difficulty: "Easy" as const, category: "Two Pointers", totalAttempts: 2, daysOverdue: 1, retrievability: 0.61, stability: 3.4, lastReviewedAt: daysAgo(5) },
];
